...
const SignUp = () => {
  ...
  const onSubmit = async () => {
    ...
    if ((await emailAvailable()) === false) {
      ...
      const userToken = await register(username, email, password, "admin");
          ...
          {accountExists ? (
            ...
            <>
              ...
              <div className={styles[`signup-form`]}>
                ...
                {/*input fields*/}
                <div className={styles[`failed-login`]}>
                      ...
                      <input
                        ...
                        onChange={async (e) => {
                          ...
                          if (e.target.value.length > 0) {
                            if (
                              !(await usernameStringAvailable(e.target.value))
                            ) {
                              setErrors({
                                ...errors,
                ...
                {loading ? (
                  ...
                  <button
                    ...
                    onClick={onSubmit}
                    onMouseEnter={() => setProgress(50)}
                    onMouseLeave={() => updateProgress()}
                  >
                    Create Account!
                  </button>
                )}

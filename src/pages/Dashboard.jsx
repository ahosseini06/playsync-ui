...
const Dashboard = () => {
  ...
  function onViewTournament(tournament) {
    setSelectedTournaments([tournament, ...selectedTournaments]);
  ...
  const onCloseEventTab = (t) => {
    ...
    setSelectedTournaments([
      ...selectedTournaments.filter((tournament) => tournament.id !== t.id),
    ]);
  };
      ...
      <div>
        <div className="App">
          ...
          <div className="tab-page">
            {tab === "manage-events" && (
              <ManageEvents onView={onViewTournament} />
            )}
            {tab === "event-dashboard" && (
              <EventDashboard
                tournaments={selectedTournaments}
                onCloseEventTab={onCloseEventTab}
              />
            )}
          </div>
        </div>
